...
use std::fmt;
#[doc = "Definition of the metric.1 format."]
...
impl MetricLogV1 {
    ...
    #[doc = "Dot-delimited name of metric, e.g. `com.foundry.compass.api.Compass.http.ping.failures`"]
    #[inline]
    pub fn metric_name(&self) -> &str {
        &*self.metric_name
    }
    #[doc = "Type of metric being represented, e.g. `gauge`, `histogram`, `counter`"]
    #[inline]
    pub fn metric_type(&self) -> &str {
        &*self.metric_type
    }
    #[doc = "Observations, measurements and context associated with the metric"]
    #[inline]
    pub fn values(&self) -> &std::collections::BTreeMap<String, conjure_object::Any> {
        &self.values
    }
    #[doc = "Additional dimensions that describe the instance of the metric"]
    #[inline]
...
#[doc = "The stage 0 builder for the [`MetricLogV1`] type"]
#[derive(Debug, Clone)]
...
#[doc = "The stage 1 builder for the [`MetricLogV1`] type"]
#[derive(Debug, Clone)]
...
#[doc = "The stage 2 builder for the [`MetricLogV1`] type"]
#[derive(Debug, Clone)]
...
impl BuilderStage2 {
    #[doc = "Dot-delimited name of metric, e.g. `com.foundry.compass.api.Compass.http.ping.failures`"]
    #[inline]
    pub fn metric_name<T>(self, metric_name: T) -> BuilderStage3
    where
        T: Into<String>,
    {
        BuilderStage3 {
...
#[doc = "The stage 3 builder for the [`MetricLogV1`] type"]
#[derive(Debug, Clone)]
...
impl BuilderStage3 {
    #[doc = "Type of metric being represented, e.g. `gauge`, `histogram`, `counter`"]
    #[inline]
    pub fn metric_type<T>(self, metric_type: T) -> BuilderStage4
    where
        T: Into<String>,
    {
        BuilderStage4 {
...
#[doc = "The stage 4 builder for the [`MetricLogV1`] type"]
#[derive(Debug, Clone)]
...
impl BuilderStage4 {
    ...
    #[doc = "Dot-delimited name of metric, e.g. `com.foundry.compass.api.Compass.http.ping.failures`"]
    #[inline]
    pub fn metric_name<T>(mut self, metric_name: T) -> Self
    where
        T: Into<String>,
    {
    ...
    #[doc = "Type of metric being represented, e.g. `gauge`, `histogram`, `counter`"]
    #[inline]
    pub fn metric_type<T>(mut self, metric_type: T) -> Self
    where
        T: Into<String>,
    {
